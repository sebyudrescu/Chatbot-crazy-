...
assert.match(orchestratorSource, /const genericDiscoveryNeedsClarification = shouldClarifyProductDiscoveryTurn/)
assert.match(orchestratorSource, /context\.query,\s*hasPriorUserTurn,\s*currentCommerceQuery/)
