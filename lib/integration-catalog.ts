...
export const INTEGRATION_CATALOG: IntegrationDefinition[] = [
  ...
  { provider: 'shopify', name: 'Shopify', category: 'commerce', description: 'Sincronizza prodotti, varianti, prezzi e disponibilità tramite Admin API.', color: '#7ab55c', initials: 'SH', mode: 'configuration', fields: [{ key: 'shopUrl', label: 'URL negozio Shopify', placeholder: 'https://negozio.myshopify.com', type: 'url' }, { key: 'adminAccessToken', label: 'Admin API access token', placeholder: 'shpat_…', type: 'secret' }, { key: 'apiVersion', label: 'Versione API', placeholder: '2026-07', type: 'text', required: false }] },
  { provider: 'woocommerce', name: 'WooCommerce', category: 'commerce', description: 'Sincronizza il catalogo pubblico senza chiedere credenziali al cliente.', color: '#96588a', initials: 'WC', mode: 'configuration', fields: [{ key: 'storeUrl', label: 'URL negozio WooCommerce', placeholder: 'https://shop.cliente.it', type: 'url' }] },
