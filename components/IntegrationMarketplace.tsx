...
interface ShopifyStatus { configured: boolean; connected: boolean; status: string; shopDomain?: string | null; callbackUrl: string; webhookUrl: string; lastError?: string | null; lastSyncedAt?: string | null; orderTracking?: { requested: boolean; granted: boolean; pcdStatus: 'unknown' | 'required' | 'scope_required' } }
