...
async function main() {
  ...
  assert.match(portalPage, /Dati protetti e separati/)
  assert.match(portalPage, /Team e accessi/)
  assert.match(portalPage, /Invita/)
  assert.match(portalPage, /Conversazioni/)
  ...
  assert.match(proxy, /path === ["']\/knowledge\/import["']/)
  assert.match(proxy, /\\\/chat\\\//)
