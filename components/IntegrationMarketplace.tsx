...
interface ShopifyStatus { configured: boolean; connected: boolean; status: string; shopDomain?: string | null; callbackUrl: string; webhookUrl: string; lastError?: string | null; lastSyncedAt?: string | null }
